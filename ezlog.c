...
/* If you declare any globals in php_ezlog.h uncomment this:
...
PHP_INI_BEGIN()
    STD_PHP_INI_ENTRY("ezlog.global_value",      "42", PHP_INI_ALL, OnUpdateLong, global_value, zend_ezlog_globals, ezlog_globals)
    STD_PHP_INI_ENTRY("ezlog.global_string", "foobar", PHP_INI_ALL, OnUpdateString, global_string, zend_ezlog_globals, ezlog_globals)
PHP_INI_END()
*/
/* }}} */
